export const resume = {
  ...
  experience: [
    {
      ...
      techStack: ["Node.js", "TypeScript", "Docker", "DDD", "PostgreSQL", "AWS"],
    },
    {
      ...
      techStack: ["Java (Spring Boot)", "Go", "Node.js", "n8n", "Playwright", "AWS (S3, SNS, SQS)", "Docker", "Redis"],
    },
    {
      company: "Legacy Tech",
      ...
      techStack: ["Node.js", "Fastify", "Docker", "PostgreSQL", "Oracle PL/SQL", "Java", "Prisma", "TypeORM", "Redis"],
    },
    {
      company: "BeFly",
      role: "Software Engineer (PJ)",
      ...
      techStack: ["Java (Spring Boot)", "Node.js", "Next.js", "Docker", "AWS", "TypeORM", "Redis", "MySQL", "SQL Server"],
    },
    {
      ...
      techStack: ["PHP", "Node.js (TypeScript)", "JavaScript", "Docker", "Oracle PL/SQL", "TypeORM", "Slim Framework", "Blip"],
    },
    {
      ...
      techStack: ["PHP", "JavaScript (XAJAX)", "MySQL", "MariaDB", "HTML", "CSS"],
    },
    {
  ...
  skills: [
    ...
    { name: "Fastify", icon: "https://raw.githubusercontent.com/devicons/devicon/master/icons/fastify/fastify-original.svg" },
    ...
    { name: "Slim Framework", icon: "https://www.vectorlogo.zone/logos/slimframework/slimframework-icon.svg" },
    { name: "Blip", icon: "" },
  ],
};
